          ...
          return (
                    <div className=" w-full h-full flex flex-row  items-center justify-center p-10">
                        <div className="w-4/12 h-full ">
                                  <Sale imgUrl={'/sale.svg'} Name={"Sales"} AddLink={"/panel/sales/add"} ViewLink={"/panel/sales"} msg={msgNewSales}></Sale>
                        </div>
...
function Block({imgUrl, Name , AddLink , ViewLink , msg}){
          return (
                    <div className="bg-gray-100 hover:translate-y-1 h-full bg-opacity-30 scale-75 hover:translate-y-1 hover:g-gray-200 transition-all duration-300 ease-in-out rounded-lg shadow-xl flex flex-col items-center justify-center">
                              ...
                              <div className="rounded-b-lg w-full flex flex-row items-center justify-center ">
                                        <a href={AddLink} className=" rounded-bl-lg w-1/2 hover:bg-gray-100  hover:text-gray-900 bg-gray-900 p-2 text-center text-gray-100">New</a>
                                        <div className="bg-gray-100 w-[1px]"></div>
                                        <a href={ViewLink} className=" w-1/2 rounded-br-lg hover:bg-gray-100 hover:text-gray-900  bg-gray-900 p-2 text-center text-gray-100">View</a>
                              </div>
                    </div>
          );
}
