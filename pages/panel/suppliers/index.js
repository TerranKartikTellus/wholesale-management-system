              ...
              async function submitForm(e){
                 e.preventDefault();
                      ...
                      if(jsonResponse.worked){
                              window.location.replace("/panel/supplier?newSupplier=Updated%20Supplier");
                      }
                      else {
                              setError(['An Error has Occured','Please Retry'])
                      }
                      ...
                      <div>
                        _id: {upd[0]}
                              <form  >
                                      ...
                                      <div   className="w-1/2 bg-transparent" >SID: <span className="p-1 text-red-500 font-semibold">old value: {upd[1]}</span></div> 
                                      ...
                                      onChange={()=>{setSid(event.target.value);}}
                                      ></input><br></br>
                                      </div>
                                      <div className=" flex flex-row text-xl capitalize justify-start items-center">
                                      <div  className="w-1/2 bg-transparent" >Sname: <span className="p-1 text-red-500 font-semibold">old value: {upd[2]}</span></div> 
                                      ...
                                      onChange={()=>{setSname(event.target.value);}}
                                      ></input>
                                      </div>
                                      <div className=" flex flex-row text-xl capitalize justify-start items-center">
                                      <div  className="w-1/2 bg-transparent" >Saddress: <span className="p-1 text-red-500 font-semibold">old value: {upd[3]}</span></div>
                                       <input defaultValue={upd[3]} className="w-1/2 bg-transparent border-b-2 px-2 py-1 border-gray-900" required 
                                      onChange={()=>{setSaddress(event.target.value);}}
                                      type="text" name="lname"></input>        
                                      </div>
                                      <div className=" flex flex-row text-xl capitalize justify-start items-center">
                                      <div  className="w-1/2 bg-transparent" >Scontact: <span className="p-1 text-red-500 font-semibold">old value: {upd[4]}</span></div> 
                                      <input defaultValue={upd[4]} className="w-1/2 bg-transparent border-b-2 px-2 py-1 border-gray-900" required
                                       onChange={()=>{setScontact(event.target.value);}}
